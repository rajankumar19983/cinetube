        ...
        <>
          {!!data && (
            <React.Fragment>
              ...
              <div className="hero_opac_layer w-full h-[250px] absolute bottom-0 left-0"></div>
              <ContentWrapper>
                <div className="flex relative flex-col gap-[25px] md:gap-[50px] md:flex-row">
                  ...
                  <div className="text-white">
                    ...
                    <div className="flex items-center gap-[25px] mb-[25px]">
                      <CircleRating
                        styles="max-w-[70px] bg-black_2 md:max-w-[90px]"
                      ...
                      {video?.key && (
                        ...
                        >
                          ...
                          />
                          <span className="text-[20px] transitionAll7By10EaseInOut">
                            Watch Trailer
                          </span>
                        </div>
                      )}
